...
import net.chrisrichardson.eventstore.examples.kanban.taskservice.backend.TaskAggregate;
import net.chrisrichardson.eventstore.examples.kanban.taskservice.backend.TaskHistoryService;
import net.chrisrichardson.eventstore.examples.kanban.taskservice.backend.TaskService;
