package net.chrisrichardson.eventstore.examples.kanban.apigateway.web;
...
public class GatewayController {
  ...
  public String proxyRequest(HttpServletRequest request) throws NoHandlerFoundException, IOException, URISyntaxException {
  ...
  private HttpUriRequest createHttpUriRequest(HttpServletRequest request) throws URISyntaxException, NoHandlerFoundException, IOException {
