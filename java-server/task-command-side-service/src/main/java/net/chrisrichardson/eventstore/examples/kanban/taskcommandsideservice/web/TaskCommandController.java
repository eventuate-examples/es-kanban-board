package net.chrisrichardson.eventstore.examples.kanban.taskcommandsideservice.web;
...
import net.chrisrichardson.eventstore.examples.kanban.webapi.HistoryEvent;
import net.chrisrichardson.eventstore.examples.kanban.webapi.HistoryResponse;
